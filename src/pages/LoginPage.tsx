    ...
    <div className="min-h-screen bg-background flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-sm text-muted-text mt-2">Sign in to your account</p>
        </div>

        <div className="bg-surface-container-lowest border border-outline-variant rounded-xl shadow-sm p-7 space-y-5">
          {error && (
            <div className="px-4 py-3 bg-error-container text-on-error-container text-sm rounded-lg">
              {error}
            </div>
          )}
