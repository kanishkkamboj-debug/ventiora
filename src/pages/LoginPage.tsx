    ...
    <div className="min-h-screen bg-[#F9F9F9] flex items-center justify-center p-4" style={{ backgroundImage: 'radial-gradient(#E2E8F0 1px, transparent 1px)', backgroundSize: '24px 24px' }}>
      <div className="max-w-[400px] w-full">
        ...
        <div className="bg-white rounded-[24px] p-8 shadow-md">
          <h2 className="font-headline-lg text-headline-lg font-bold text-on-surface mb-6">Log in</h2>
          
          <form className="flex flex-col gap-5" onSubmit={handleLogin}>
            <div className="flex flex-col gap-1.5">
              <label className="font-label-md text-label-md font-semibold text-on-surface">University Email</label>
              <input 
                type="email" 
            ...
            <div className="flex flex-col gap-1.5">
              ...
              <div className="flex justify-end mt-1">
                <Link to="/forgot-password" className="font-label-sm text-label-sm font-semibold text-primary hover:underline">
                  Forgot password?
                </Link>
              </div>
            </div>
            ...
            <button 
              type="button"
              className="w-full bg-white border border-border text-on-surface font-label-md text-label-md px-6 py-3.5 rounded-full hover:bg-surface-container-low transition-colors flex items-center justify-center gap-3"
            >
